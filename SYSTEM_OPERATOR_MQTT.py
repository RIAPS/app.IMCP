...
class SYSTEM_OPERATOR_MQTT(Component):
    ...
    def on_consensus_sub(self):
        ...
        msg = from_bytes(imcp_capnp.DgGeneralMsg, msg_bytes).to_dict()
    ...
    def on_relay_sub(self):
        ...
        msg_capnp = from_bytes(imcp_capnp.RelayMsg, msg_bytes)
    ...
    def filter_mqtt(self, msg, schema_name):
        ...
        if (
            self.mqtt_peer_msg_count[sender] % self.mqtt_peer_msg_count["subsample_nth"]
            != 0
        ):
            return
    ...
    def send_operator_msg(self, requested_relay):
        ...
        operator_msg.requestedAction = self.target_status_of_relays.get(
            requested_relay, "NONE"
        )
